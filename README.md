...
[![Version](https://img.shields.io/badge/version-1.4.1-2ecc71?style=flat)](RELEASE_NOTES_v1.4.1.md)
...
├── RELEASE_NOTES_v1.4.0.md   # Notas da versão 1.4.0 (dashboard de indicadores)
├── RELEASE_NOTES_v1.4.1.md   # Notas da versão atual (feriados móveis e linters)
└── README.md
```
...
> Veja as notas completas da versão atual em [RELEASE_NOTES_v1.4.1.md](RELEASE_NOTES_v1.4.1.md).
...
Desenvolvido com ☕ e Python · 2026 · v1.4.1
