...
export const Selectroot_select__root_b8f8defece91ad1276e17b4658525efe = memo(({children}) => {
...
const reflex___state____state__sandbox_reflex___state____auth_state__sandbox_reflex___data_state____data_state = useContext(StateContexts.reflex___state____state__sandbox_reflex___state____auth_state__sandbox_reflex___data_state____data_state)
    ...
    return(
        jsx(RadixThemesSelect.Root,{onValueChange:on_change_78b63321551380a4883ac9ec4ce6eb72,value:reflex___state____state__sandbox_reflex___state____auth_state__sandbox_reflex___data_state____data_state.mes_ref_rx_state_},children)
    )
});
