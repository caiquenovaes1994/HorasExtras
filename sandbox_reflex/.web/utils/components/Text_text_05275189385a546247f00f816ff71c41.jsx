...
export const Text_text_05275189385a546247f00f816ff71c41 = memo(({children}) => {
...
const on_click_0688bdbe68194d253ec82a2962127057 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.sandbox_reflex___state____auth_state.toggle_policy", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
    ...
    return(
        jsx(RadixThemesText,{as:"p",css:({ ["cursor"] : "pointer", ["textDecoration"] : "underline", ["color"] : "var(--blue-11)" }),onClick:on_click_0688bdbe68194d253ec82a2962127057,weight:"bold"},children)
    )
});
